...
@Repository
public interface TestHdmsResultHistRepository extends JpaRepository<TestHdmsResultHist, String> {
	 ...
	 * WITH RESOURCE AS 		                                                                                                        
		(                                                                                                                                                  
			SELECT TTID, TERML_IP, SPLIT_PART(TERML_IP, '(', 1) AS IP, REPLACE(SPLIT_PART(TERML_IP, '(', 2), ')' , '') AS GW_IP, TERML_TYPE                
				  ...
				  , (SELECT COUNT(TERML_TYPE) FROM TB_HDMS_RESLT_HIST WHERE TTID = :ttId AND TERML_TYPE = 'H') AS TERML_TYPE_H_CNT
				  , (SELECT COUNT(TERML_TYPE) FROM TB_HDMS_RESLT_HIST WHERE TTID = :ttId AND TERML_TYPE IN('S', 'G', 'GA')) AS TERML_TYPE_ETC_CNT
				  , NOW() AS CRET_DT, SCN				                                                                                                        
	          FROM TB_HDMS_RESLT_HIST                                                                                                                              
			 WHERE TTID = :ttId                                                                                                                              
		),
	*/
